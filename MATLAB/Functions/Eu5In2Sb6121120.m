...
EXP.mono.mosaic=30;         %Minutes of arc, default=25, BT7=30
%EXP.mono.vmosaic=45;       %...For anisotropic mosaic: vertical mosaic, minutes of arc
EXP.ana.tau='PG(002)';      %PG(002)
EXP.ana.mosaic=30;          %Minutes of arc, default=25, BT7=30
...
EXP.hcol=[50 50 50 120];        % Horizontal collimation: FWHM minutes of arc, limited to a maximum by FWHM calculation.
...
EXP.efixed=35;    %Fixed neutron energy in meV
...
EXP.orient1=[0 1 0]; %First orienting vector in scattering plane
