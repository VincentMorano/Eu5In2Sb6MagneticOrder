function [xFit,redChi2Fit,xErr,chiUpper,chiTrial,paramTrial,interpPts,slopes,intercepts,paramLower,paramUpper] = fitRedChi2ErrCon(data,dataErr,model,x0,errPts,fact,offset,lb,ub)
